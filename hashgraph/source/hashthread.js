...
export default class HashThread {
    ...
    sendEvent(hashEvent) {
        if (hashEvent instanceof HashEvent) {
            ...
            this.eventHeads[hashEvent.eventSource] = Math.max(this.eventHeads[hashEvent.eventSource] || 0, newevent.eventIndex);
